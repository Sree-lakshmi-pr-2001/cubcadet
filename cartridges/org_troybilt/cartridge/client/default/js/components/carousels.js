...
var exportLyonsmfra = $.extend({}, lyonsmfra, {
    pdpCarousel: function () {
        ...
        $('.pdp-carousel').not('.slick-initialized').each(function () {
            imagesloaded($(this)).on('done', function (carousel) {
                ...
                var pdpSliderControls = '#sliderControls-' + productID;

                // Add unique class to prevent multiple nav sliders from effecting each other -  ex. Set PDPs
                slickConfigs.pdp.appendDots = $(pdpSliderControls + ' .slide-dots');
                slickConfigs.pdp.prevArrow = $(pdpSliderControls + ' .slide-prev');
                slickConfigs.pdp.nextArrow = $(pdpSliderControls + ' .slide-next');
                slider.slick(slickConfigs.pdp);
    ...
    landingGalleryCarousels: function () {
        $('.landing-gallery-caro').not('.slick-initialized').slick(slickConfigs.landingGallery);
        var slideWrapper = $('.landing-gallery-caro');
        videoControlsInit(slideWrapper);
    },
    ...
    contentAssetCarousel: function () {
        $('.content-asset-caro').not('.slick-initialized').slick(slickConfigs.contentAssetCarousel);
    ...
    blogCarousels: function () {
        $('.blog-tile-caro').not('.slick-initialized').each(function (idx) {
            var $slider = $(this);
    ...
    categorySubFolder: function () {
        $('.category-subfolder-tile-caro').not('.slick-initialized').slick(slickConfigs.categorySubFolderTiles);
    },
    ...
    productRelatedContent: function () {
        $('.product-related-content-tile-caro').not('.slick-initialized').slick(slickConfigs.productRelatedContent);
    },
