        ...
        $.each(uuidEl, function (shipmentIndex, el) {
            ...
            if ($shippingMethodList && $shippingMethodList.length > 0) {
                ...
                $.each(shippingMethods, function (methodIndex, shippingMethod) {
                    ...
                    // set shipping cost
                    var shippingCost = shippingMethod.adjustedShippingCost && shippingMethod.adjustedShippingCost.formatted ? shippingMethod.adjustedShippingCost.formatted : shippingMethod.shippingCost;
                    $('.shipping-cost', tmpl).text(shippingCost);
...
function updateShippingSummaryInformation(shipping, order) {
    $('[data-shipment-summary=' + shipping.UUID + ']').each(function (i, el) {
        ...
        if (selectedShippingMethod) {
            ...
            $summaryDetails.show();
            factoryDeliveryHeader.text(selectedShippingMethod.displayName);
