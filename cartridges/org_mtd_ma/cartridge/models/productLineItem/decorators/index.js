...
module.exports = {
    ...
    trackingNumber: require('*/cartridge/models/productLineItem/decorators/trackingNumber'),
    ...
    miniCartRenderedPrice: require('*/cartridge/models/productLineItem/decorators/miniCartRenderedPrice'),
    productType: require('*/cartridge/models/productLineItem/decorators/productType'),
    extendedName: require('*/cartridge/models/productLineItem/decorators/extendedName')
};
