...
module.exports = function fullProduct(product, apiProduct, options) {
    ...
    if (options.variationModel) {
        decorators.images(product, options.variationModel, { types: ['large', 'quickview'], quantity: 'all' });
        imageZoomDecorator(product, options.variationModel, { types: ['hi-res'], quantity: 'all' });
    } else {
        decorators.images(product, apiProduct, { types: ['large', 'quickview'], quantity: 'all' });
