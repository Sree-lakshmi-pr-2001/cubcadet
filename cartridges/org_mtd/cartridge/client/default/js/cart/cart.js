...
var baseOrg = require('../product/base');
 ...
 */
function confirmDelete(actionUrl, productID, productName, uuid, gtmData, qty) {
...
module.exports = function () {
    $('body').on('click', '.remove-product', function (e) {
        ...
        confirmDelete(actionUrl, productID, productName, uuid, gtmData, qty);
    });
    ...
    $('body').on('click', '.cart-page .product-edit .edit, .cart-page .bundle-edit .edit', function (e) {
        ...
        baseOrg.availability(); // init availability update
    });
    ...
    baseOrg.selectAttribute();
    baseOrg.colorAttribute();
