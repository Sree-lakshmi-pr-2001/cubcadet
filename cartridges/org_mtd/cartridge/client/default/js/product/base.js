...
function enableAddAllItemsToCart() {
    ...
    var enable = $('.product-availability').toArray().every(function (item) {
        return $(item).data('available') && $(item).data('ready-to-order') && $(item).data('buyable') !== false && $(item).data('request-demo') !== true;
    });
    ...
    addToCart: function () {
        ...
        $('body').on('product:updateAddToCart', function (e, response) {
            ...
            $('button.add-to-cart', response.$productContainer).attr('disabled',
                (!response.product.readyToOrder || !response.product.available || response.product.isBuyable === false || response.product.requestDemo === true));
