...
function showConsentModal() {
    if (!$('.tracking-consent').data('caonline') || !$('.tracking-consent').data('ctpreference')) {
        return;
    }
    ...
    var htmlString = '<!-- Modal -->'
        + '<div class="modal show" id="consent-tracking" role="dialog" style="display: block;" aria-labelledby="modal-title" data-la-initdispnone="true">'
