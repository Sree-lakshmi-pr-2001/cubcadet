...
function Message(customerKey, sendID) {
    Logger.error('mtd - Message customerKey : ' + customerKey + ', sendID : ' + sendID);
...
Message.prototype = {
    ...
    setTo: function(address) {
        Logger.error('mtd - setTo : ' + JSON.stringify(address));
        this.to.address = address;
        this.to.subscriberKey = address;
        Logger.error('mtd - setTo => ' + JSON.stringify(this.to));
        return this;
    },
    /**
     * Set ASYNC on/off
