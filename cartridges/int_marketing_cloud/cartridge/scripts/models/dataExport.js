...
function DataExport(exportID) {
    Logger.error('mtd - DataExport => ' + exportID);
    /**
     * The export ID
     * @type {string}
     */
    ...
    Logger.error('mtd - this.attributes=>');
    Logger.debug(JSON.stringify(this.attributes));
    /**
...
DataExport.prototype = {
    _buildHeader: function _buildHeader() {
        Logger.error('mtd - DataExport _buildHeader');
    ...
    buildRow: function buildRow(data) {
        Logger.error('mtd - DataExport buildRow ' + JSON.stringify(data));
